...
class GeminiProvider(BaseLLMProvider):
    ...
    def _resolve_base_url(self, base_url: str | None) -> str:
        url = (base_url or self.config.base_url or DEFAULT_GEMINI_BASE_URL).rstrip("/")
        return url
    ...
    def chat_complete(
        ...
        **kwargs: Any,
        ...
        payload: dict[str, Any] = {
            "model": model or self.config.llm_model or DEFAULT_GEMINI_MODEL,
    ...
    def embed_query(
        ...
        **kwargs: Any,
        ...
        payload: dict[str, Any] = {
            "model": model or self.config.embedding_model or DEFAULT_GEMINI_EMBEDDING_MODEL,
            "input": text or " ",
